...
public class Login extends AppCompatActivity {
    ...
    TextView createNewAccountViewButton,mgotoforgotpassword;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        createNewAccountViewButton.setOnClickListener((v) -> startActivity(new Intent(Login.this, SignupAccount.class)));
