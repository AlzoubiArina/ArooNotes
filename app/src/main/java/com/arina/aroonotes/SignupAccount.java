...
public class SignupAccount extends AppCompatActivity {
    ...
    void createAccountInFirebase(String email, String password) {
        ...
        firebaseAuth.createUserWithEmailAndPassword(email, password).addOnCompleteListener(SignupAccount.this, new OnCompleteListener<AuthResult>() {
            @Override
            public void onComplete(@NonNull Task<AuthResult> task) {
                changeInProgress(false);
                if (task.isSuccessful()) {
                    //create account is done
                    Tools.showToast(SignupAccount.this, "Successful create account Check email to verify");
                    ...
                    //failure
                    Tools.showToast(SignupAccount.this, task.getException().getLocalizedMessage());
                }
